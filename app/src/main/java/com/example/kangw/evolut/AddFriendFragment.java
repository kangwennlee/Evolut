        ...
        friend_reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.hasChild(friendUserId)){
                    addFriend_feedback.setText("Action cannot be done, " + friendName + " is already your friend" + !dataSnapshot.hasChild(friendUserId));
                }
                if(!dataSnapshot.hasChild(friendUserId)){
                    friend_reference.child(friendUserId).child("Name").setValue(friendName);
                    addFriend_feedback.setText("Successfully added " + friendName + " in your friend list" + dataSnapshot.hasChild(friendUserId));
                }
